...
models = [(3,'/home/local/ASURITE/speddira/dev/traffic_sense_net/city_scale/xgboost/saved_models/V4/incident_classification_xg_model.pkl'),
          (4,'/home/local/ASURITE/speddira/dev/traffic_sense_net/city_scale/xgboost/saved_models/V8/incident_classification_xg_model.pkl'),
          (5,'/home/local/ASURITE/speddira/dev/traffic_sense_net/city_scale/xgboost/saved_models/V12/incident_classification_xg_model.pkl'),
          (6,'/home/local/ASURITE/speddira/dev/traffic_sense_net/city_scale/xgboost/saved_models/V16/incident_classification_xg_model.pkl'),
          (7,'/home/local/ASURITE/speddira/dev/traffic_sense_net/city_scale/xgboost/saved_models/V20/incident_classification_xg_model.pkl'),
          (8,'/home/local/ASURITE/speddira/dev/traffic_sense_net/city_scale/xgboost/saved_models/V24/incident_classification_xg_model.pkl')
          ]
